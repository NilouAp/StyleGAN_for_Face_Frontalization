...
class TestOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--exp_dir', type=str, default = './WV/pixel2style2pixel_H/OUTPUT_new',help='Path to experiment output directory')
		self.parser.add_argument('--checkpoint_path', default='./WV/pixel2style2pixel_H/pretrained_models/psp_ffhq_frontalization.pt', type=str, help='Path to pSp model checkpoint')
		self.parser.add_argument('--data_path', type=str, default='./WV/pixel2style2pixel_H/test_nilou_ffhq', help='Path to directory of images to evaluate')
